...
\item Structural Change, Land Use and Urban Expansion, joint with Nicolas Coeurdacier, and Marc Teigner. {\it Revise and Resubmit at Review of Economic Studies}
...
Graduated with PhD from SciencesPo:

\begin{itemize}
    \item[2018:] Odran Bonnet, Economist at INSEE
    \item[2019:] Eduardo Ciscato, Assistant Prof at KU Leuven
    \item[2020:] Julien Pascal, Economist at Central Bank of Luxembourg
    \item[2021:] Aseem Patel, Assistant Prof at Essex U (comité de suivi)
    \item[2022:] Pauline Corblet, Assistant Prof at NYU Abu Dhabi
\end{itemize}

Supporting letters for SciencesPo Master Students:

\begin{itemize}
    \item Hugo L'Huillier (PhD student at Princeton on Market 2023/2024)
    \item Jeanne Sorin (PhD student at U Chicago)
    \item Xinyu Dai (PhD student at Brown)
    \item Alberto Nasi (PhD student at Bocconi)
\end{itemize}
